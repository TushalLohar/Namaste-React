...
const Header = () => {
  ...
  //subscribing to the stor using the slector
  const cartItems = useSelector((x_store) => x_store.cart.items);
      ...
      <div className="max-w-7xl mx-auto flex justify-between items-center px-6 sm:px-12 h-20">
        ...
        >
          <div className="relative">
            ...
            <div
              className={`absolute -bottom-1 -right-1 w-3.5 h-3.5 rounded-full border-2 border-white shadow-sm transition-colors duration-500 ${
